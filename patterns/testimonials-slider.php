...
$quotation_img_url = NASIO_BLOCKS_URL . 'assets/img/quotation.png';
$quotation_green_img_url = NASIO_BLOCKS_URL . 'assets/img/quotation-1.png';
$team_member_img_url = NASIO_BLOCKS_URL . 'assets/img/team-member-01.jpg';
...
<figure class="wp-block-image aligncenter size-full is-resized"><img src="' . esc_url( $quotation_img_url ) . '" alt="" class="wp-image-2475" style="width:32px;height:auto"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-large is-resized has-custom-border"><img src="' . esc_url( $team_member_img_url ) . '" alt="" class="wp-image-2174" style="border-radius:50px;object-fit:cover;width:80px;height:80px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<figure class="wp-block-image aligncenter size-full is-resized"><img src="' . esc_url( $quotation_green_img_url ) . '" alt="" class="wp-image-2474" style="width:32px;height:auto"/></figure>
<!-- /wp:image -->
...
<!-- wp:nasio-block/slide -->
<div class="wp-block-nasio-block-slide nasio-slide swiper-slide"><div class="nasio-slide-inner"><!-- wp:cover {"dimRatio":40,"customOverlayColor":"#000000","isUserOverlayColor":true} -->
<div class="wp-block-cover"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-40 has-background-dim" style="background-color:#000000"></span><div class="wp-block-cover__inner-container"><!-- wp:heading {"placeholder":"Add slide title...","textColor":"white"} -->
