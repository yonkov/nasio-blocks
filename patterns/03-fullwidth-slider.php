...
$content='<!-- wp:nasio-block/content-slider {"displayMode":"fullwidth","arrowColor":"#ffffff","align":"full"} -->
<div class="wp-block-nasio-block-content-slider alignfull is-display-mode-fullwidth" style="--space-between:20px;--swiper-navigation-sides-dynamic-offset:8px;--arrow-color:#ffffff;--pagination-active-color:#333;--pagination-inactive-color:#ccc" data-space-between="20" data-loop="true" data-mode="fullwidth" data-autoplay="false" data-autoplay-delay="3000" data-show-dots="true" data-show-arrows="true" data-draggable="true"><div class="nasio-content-slider swiper"><div class="swiper-wrapper"><!-- wp:nasio-block/slide -->
...
<div class="wp-block-cover" style="min-height:600px"><img class="wp-block-cover__image-background wp-image-2854" alt="Railway road during sunset" src="' . esc_url( $images[0] ) . '" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-30 has-background-dim" style="background-color:#7a797d"></span><div class="wp-block-cover__inner-container"><!-- wp:heading {"textAlign":"center","placeholder":"Add slide title...","textColor":"white","fontSize":"x-large"} -->
...
<div class="wp-block-cover is-light" style="min-height:600px"><img class="wp-block-cover__image-background wp-image-2850" alt="A landscape view of the snow-capped Alps in the distance" src="' . esc_url( $images[1] ) . '" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-30 has-background-dim" style="background-color:#788485"></span><div class="wp-block-cover__inner-container"><!-- wp:heading {"textAlign":"center","placeholder":"Add slide title...","style":{"spacing":{"padding":{"top":"1rem","bottom":"1rem"}}},"textColor":"white","fontSize":"x-large"} -->
...
<div class="wp-block-cover is-light" style="min-height:600px"><img class="wp-block-cover__image-background wp-image-2851" alt="A serene landscape depicting a misty forest setting at dawn or dusk" src="' . esc_url( $images[2] ) . '" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-40 has-background-dim" style="background-color:#788485"></span><div class="wp-block-cover__inner-container"><!-- wp:heading {"textAlign":"center","placeholder":"Add slide title...","style":{"spacing":{"padding":{"top":"1rem","bottom":"1rem"}}},"textColor":"white","fontSize":"x-large"} -->
