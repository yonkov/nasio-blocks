...
* **Content Slider Block**:  Custom block to create beautiful responsive sliders
* Choose between Fullwidth Slider or Carousel (multi-column slider) display mode
...
* Responsive design that works on all devices
* Support for the Cover block for the content of the slide

* **Gallery Slider Block**:  Custom block the users to display galleries in beautiful multi-column carousels
* Fully customizable settings for slider behavior
* Ability to add a gallery the familiar block editor interface
* Responsive design that works on all devices

* **Icon Block**:  Uses WordPress Icons Library (@wordpress/icons) to allow users to beautiful and scalable icons on their website
* Different font size, color and background color.
* Different spacing options

* **Accordeon**: Display an FAQ-style section in the form of expandable/collabsible accordeons.
* Option to show a default Open Item
